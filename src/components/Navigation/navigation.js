...
import homePalm from '@public/rename/home.png';
...
function Navigation() {
    ...
    const tertiaryMenuRef = useRef(null);
    ...
    const textTouch = {
        ...
        tap: { color: '#007bff', background: '#007bff' },
    };
    ...
    const handleOutsideClick = useCallback(
        (e) => {
            ...
            const isClickOutsidePrimaryMenu =
                menuRef.current && !menuRef.current.contains(e.target);
            const isClickOutsideSecondaryMenu =
                isSecondaryMenuOpen &&
                secondaryMenuRef.current &&
                !secondaryMenuRef.current.contains(e.target);
            const isClickOutsideTertiaryMenu =
                isTertiaryMenuOpen &&
                tertiaryMenuRef.current &&
                !tertiaryMenuRef.current.contains(e.target);

            if (
                isClickOutsidePrimaryMenu &&
                (!isSecondaryMenuOpen || isClickOutsideSecondaryMenu) &&
                (!isTertiaryMenuOpen || isClickOutsideTertiaryMenu)
            ) {
                handleClose();
            }
        },
        [isMenuOpen, handleClose, isSecondaryMenuOpen, isTertiaryMenuOpen]
    );
        ...
        <>
            {path !== '/' && (
                <>
                    ...
                    {isMenuOpen === false && isMobile === false && (
                        <div className="fixed top-5 right-24  flex gap-2 border-2 p-1 rounded-3xl  border-outerSpace text-outerSpace z-40 ">
                            <button className="hover:bg-stevenBlue hover:bg-opacity-30 hover:text-stevenBlue p-1 rounded-3xl ease-in-out">
                                <a
            ...
            <div className=" fixed top-5 right-5 z-40 ">
                ...
                {isMobile === false ? (
                    ...
                    <AnimatePresence>
                        {isMenuOpen && (
                            <motion.div className=" absolute right-0 top-0 bottom-0 w-[350px] h-[70px] rounded-lg text-black flex flex-col z-10  text-xs overflow-hidden">
                                <motion.div
                                    ref={menuRef}
                                    className={` flex w-full justify-between items-center h-full px-2 ${
                                        isMenuOpen
                                            ? 'nav-menu-background-open'
                                            : 'nav-menu-background'
                                    }`}
                                ...
                                >
                                    <motion.button
                                        className="flex items-center flex-col control-button"
                                        initial={{ opacity: 0, x: 200 }}
                                        animate={{ opacity: 1, x: 0 }}
                                        transition={{
                                            duration: 0.3,
                                    ...
                                    <motion.button
                                        className="flex items-center flex-col audio-button"
                                        initial={{ opacity: 0, x: 200 }}
                                        animate={{ opacity: 1, x: 0 }}
                                        transition={{
                                            duration: 0.3,
                                    ...
                                    >
                                        <motion.button
                                            className="flex items-center flex-col  about-button"
                                            initial="initial"
                                            animate="animate"
                                            transition={{
                                                duration: 0.3,
                                            ...
                                            variants={aboutButtonVariants}
                                        >
                                            <motion.div className="w-7 h-7 relative">
                                                <motion.svg
                                                    className="figure w-10 h-10 absolute -top-2 -left-2"
                                                    viewBox="0 0 100 100"
                                                    variants={stickMan}
                                                    fill="currentColor"
                                                >
                                    ...
                                    >
                                        <motion.button
                                            className="flex items-center flex-col  contact-button"
                                            initial={{ opacity: 0, x: 200 }}
                                            animate={{ opacity: 1, x: 0 }}
                                            transition={{
                                                duration: 0.3,
                                        ...
                                        >
                                            <div className="relative">
                                                <svg
                                                    xmlns="http://www.w3.org/2000/svg"
                                                    className="w-7 h-7  contact-button-box"
                                                    viewBox="0 0 24 24"
                                                    fill="none"
                                                >
                                                    <path
                                    ...
                                    <motion.button
                                        className="flex items-center flex-col  close-button text-white"
                                        initial={{ opacity: 0, x: 200 }}
                                        animate={{ opacity: 1, x: 0 }}
                                        transition={{
                                            duration: 0.3,
                                    ...
                                    >
                                        <div className="h-7 w-7 relative">
                                            <svg
                                                xmlns="http://www.w3.org/2000/svg"
                                                className="h-7 w-7  rounded-full p-1  close-button-svg absolute -top-[1px] left-1/2 -translate-x-1/2"
                                                viewBox="0 0 24 24"
                                                fill="none"
                                            >
                                                <path
                ...
                {isMobile === false ? (
                        ...
                        {isSecondaryMenuOpen && isMenuOpen && (
                            <motion.div className=" absolute right-0 top-60 bottom-0 w-[550px] h-[300px] rounded-lg text-black flex flex-col z-10  text-xl overflow-hidden">
                                <motion.div
                                    ...
                                    initial="closed"
                                    animate={
                                        isSecondaryMenuOpen ? 'open' : 'closed'
                                    }
                                    exit={'exit'}
                                >
                                    <motion.button
                    ...
                    <AnimatePresence>
                        {isSecondaryMenuOpen && isMenuOpen && (
                            <motion.div className=" absolute right-0 top-40 bottom-0 w-[350px] h-[300px] rounded-lg text-black flex flex-col z-10  text-xl overflow-hidden">
                                <motion.div
                                    ref={secondaryMenuRef}
                                    className={` flex w-full justify-between items-center h-full px-2 ${
                                        isSecondaryMenuOpen
                        ...
                        {isTertiaryMenuOpen && isMenuOpen && (
                            <motion.div className=" absolute right-0 top-96 bottom-0 w-[550px] h-[300px] rounded-lg text-black flex flex-col z-10  text-xl overflow-hidden">
                                <motion.div
                                    ...
                                    initial="closed"
                                    animate={
                                        isTertiaryMenuOpen ? 'open' : 'closed'
                                    }
                                    exit={'exit'}
                                >
                                    <motion.button
