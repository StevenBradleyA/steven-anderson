    ...
    return (
        <>
            {isMobile === false ? (
                ...
                <motion.div
                    className="text-xl text-black absolute bottom-10 right-5 z-50 bg-white/70 p-5 w-[350px] h-[155px] rounded-lg flex  "
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
                    transition={{ ease: 'easeInOut', duration: 1 }}
                >
                    <AnimatePresence>
                        {currentControlType === 'movement' && (
                            ...
                            >
                                  <div className="flex flex-col items-start  ">
                                    <h2 className="px-2 bg-none hover:bg-stevenBlue hover:bg-opacity-30 flex p-1 rounded-lg ease-in-out ">{`movement < Follow Mode >`}</h2>
